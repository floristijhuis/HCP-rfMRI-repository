...
atlaspath="/atlases/Glasser/Q1-Q6_RelatedValidation210.CorticalAreas_dil_Final_Final_Areas_Group_Colors_with_Atlas_ROIs2.32k_fs_LR.dlabel.nii" #this is an example, any full path to a correct CIFTI .dlabel file will work
atlasname="GlasserFreesurfer" #this will become part of the final file name

inputpathhighest="/data/public_data/HCPAgingFull/fmriresults01" #fmriresults01 is a standard folder in the HCP file organisation, it contains subject-specific folders
outputpathhighest="/data/public_data/HCPAgingDerivatives" #where you want to put the output
...
mkdir $outputpathhighest/${SUBJECT}/${SUBJECTVISIT}
...
outputpathsession="$outputpathhighest/${SUBJECT}/${SUBJECTVISIT}/${SESSION}"
