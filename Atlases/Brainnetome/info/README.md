...
<li>The CIFTI cortical file had some issues with the labeling of the vertices and the regions (with some impossible regions that led to empty rows in the time series). Therefore, this was first fixed:
	<ol><li>The numbering of the vertices was first altered using USE RELATIVE LINK [test](../../../Scripts/bna_atlas_correct_numbering_vertices.m) (to put the vertices of the right hemisphere in the correct label)</li>
